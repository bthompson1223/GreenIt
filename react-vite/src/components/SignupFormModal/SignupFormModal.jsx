  ...
  return (
    <div className="login-signup-container">
      ...
      <form className="login-signup-form" onSubmit={handleSubmit}>
        <label htmlFor="email">
          <p>
            <span className="required-form">* </span>Email:
          </p>
          <input
            name="email"
            type="text"
        ...
        <label>
          <p>
            <span className="required-form">* </span>Username:
          </p>
          <input
            type="text"
            value={username}
        ...
        <label>
          <p>
            <span className="required-form">* </span>First Name:
          </p>
          <input
            type="text"
            value={firstName}
        ...
        <label>
          <p>
            <span className="required-form">* </span>Last Name:
          </p>
          <input
            type="text"
            value={lastName}
        ...
        <label>
          <p>
            <span className="required-form">* </span>Password:
          </p>
          <input
            type="password"
            value={password}
        ...
        <label>
          <p>
            <span className="required-form">* </span>Confirm Password:
          </p>
          <input
            type="password"
