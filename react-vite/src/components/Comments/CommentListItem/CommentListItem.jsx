...
const CommentListItem = ({ comment }) => {
  ...
  const isCommenter = user?.id == comment.owner_id;
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.values(validationErrors).length) {
      ...
      dispatch(thunkCreateComment(postId, commentData));
    ...
    <div className="comment-container">
      <div className="commenter-div">
        ...
        <div className="commenter-data">
          ...
          {postedDaysAgo > 0 && (
            <p>
              {postedDaysAgo} {postedDaysAgo > 1 ? "days" : "day"} ago
            </p>
          )} */}
        </div>
        {isCommenter && (
      ...
      <div className="new-reply-div">
        {!showReplyField && user && (
          <button id="reply-button" onClick={() => setShowReplyField(true)}>
            Reply
          </button>
        )}
        {showReplyField && (
          <div className="comment-replies">
            ...
            <div className="comments-errors-buttons">
              <div className="errors">
                {"reply" in errors && <span>{errors.reply}</span>}
              </div>
